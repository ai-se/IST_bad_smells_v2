...
\item Again, in advance undertake power calculations to determine the likelihood of the study finding an effect of the expected size.  Where possible, i.e., there are relevant previous studies use a bias-corrected pooled estimate \cite{Schm14}.
